...
public class TSPRecursiveDP {
    ...
    public TSPRecursiveDP(double[][] distance) {
        this(0, distance);
    }

    public TSPRecursiveDP(int startNode, double[][] distance) {
    ...
    public static void main(String[] args) {
        ...
        TSPRecursiveDP solver = new TSPRecursiveDP(distanceMatrix);
